<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Syst_Config_LB_A.aspx.cs" Inherits="Lab.Syst_Config_LB_A" %>
...
<head runat="server">
 ...
 <style>
    ...
    .darken-grey-text {
        ...
        .hm2-gradient {
           background-image: linear-gradient(135deg, #83EAF1 10%, #63A4FF 100%);
        }
                ...
                <div class="card-body hm2-gradient">
                   ...
                   <br />
                    <div class="col-md-12">
                            ...
                            <h1 style="color:darkblue;text-align:center;font-family:'Century';font-weight:bold;">
                                SYSTEM &nbsp;HARDWARE &nbsp;CONFIGURATION <br />LAB &nbsp;A</h1>
                     </div>
                    <br /><br />
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr> <th scope="row">3 </th> <td>No. of System</td>  <td>10 NOS</td> </tr>
