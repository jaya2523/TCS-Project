<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LAB_B.aspx.cs" Inherits="Lab.LAB_B" %>
...
<body onload="startLoop();">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                 ...
                 <ul class="nav">
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="LAB_B.aspx">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="SoftUsg_LabB.aspx">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="Syst_Config_LB_B.aspx">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="SoftList_LB_B.aspx">
                ...
                <div class="content-wrapper" style="background-color: #ffe9e9">
                    ...
                    <div class="page-header">
                        ...
                        <h3 class="page-title">
                            ...
                            </span><b style="text-transform: uppercase; font-size: 21px; color: darkblue">LAB B Hardware Usage Analysis</b>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 stretch-card grid-margin">
                            <marquee behavior="scroll" direction="up" scrollamount="6" id="myMarquee1">
                                ...
                                <div class="card card-img-holder text-white" style="background-image: linear-gradient(135deg, #f9c449 10%, #fe7a15 100%);">

                                    <div class="card-body">

                                        <img src="circle.png" class="card-img-absolute" alt="circle-image" />

                                        <h4 class="font-weight-normal mb-3"><b>Actual Resource Consumption <br />of LAB B Per Day</b> &nbsp;<i class="mdi mdi-chart-line mdi-24px float-right"></i>
                        ...
                        <div class="col-md-4 stretch-card grid-margin">
                            <marquee behavior="scroll" direction="up" scrollamount="6" id="myMarquee2">
                                ...
                                <div class="card card-img-holder text-white" style="background-image: linear-gradient(135deg, #004e92 10%, #000428 100%);">

                                    <div class="card-body">

                                        <img src="circle.png" class="card-img-absolute" alt="circle-image" />

                                        <h4 class="font-weight-normal mb-3"><b>Actual Resource Consumption <br />of LAB B Per Week</b> &nbsp;<i class="mdi mdi-chart-line mdi-24px float-right"></i>
                        ...
                        <div class="col-md-4 stretch-card grid-margin">
                            <marquee behavior="scroll" direction="up" scrollamount="6" id="myMarquee3">
                                ...
                                <div class="card card-img-holder text-white" style="background-image: linear-gradient(135deg, #e8a49c 10%, #f04393 100%);">
                    ...
                    <div class="row">
                        ...
                        <div class="page-header">
                            ...
                            <h3 class="page-title">
                                ...
                                </span><b style="text-transform: uppercase; font-size: 20px; color: darkblue">Actual Usage of Systems in LAB B</b>
                    ...
                    <div class="row">
                        ...
                        <div class="page-header">
                            ...
                            <h3 class="page-title">
                                ...
                                </span><b style="text-transform: uppercase; font-size: 20px; color: darkblue">Expected Usage of Systems in LAB B According to the Time Table</b>
    ...
    <script> 
        ...
        gradient.addColorStop(0, 'rgba(255, 192,0, 85)');

        gradient.addColorStop(0.5, 'rgba(255, 192,0, 0.05)');

        gradient.addColorStop(1, 'rgba(255, 225, 134, 0)');

        gradient2.addColorStop(0, 'rgba(249, 0,92, 100)');

        gradient2.addColorStop(0.5, 'rgba(249, 0,92, 0.5)');
    ...
    <script>
        ...
        gradient.addColorStop(0, 'rgba(174,29,166, 100)');
        gradient.addColorStop(0.5, 'rgba(174,29,166,0)');
        gradient.addColorStop(1, 'rgba(174,29,166, 0)');
        gradient2.addColorStop(0, 'rgba(118,255,0, 100)');
        gradient2.addColorStop(0.5, 'rgba(118,255,0, 0.25)');
        gradient2.addColorStop(1, 'rgba(118,255,0, 0)');
