...
namespace Lab
{
    public partial class SoftUsg_LabA : System.Web.UI.Page
    {
        public int total;
        public int total2;
        public int total3;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (list.Count > 0)
            {
                ...
                Literal1.Text = chartData5;
                Literal2.Text = chartData6;

                ltChartData5.Text = chartData3;
                ltChartData6.Text = chartData4;

                ltChartData3.Text = chartData7;
                ltChartData4.Text = chartData8;
            }
