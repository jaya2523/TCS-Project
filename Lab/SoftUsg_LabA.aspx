<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoftUsg_LabA.aspx.cs" Inherits="Lab.SoftUsg_LabA" %>
                ...
                <div class="content-wrapper" style="background-color: #ffe9e9">
                    ...
                    <div class="page-header">
                        ...
                        <h3 class="page-title">
                            ...
                            </span><b style="text-transform: uppercase; font-size: 21px; color: darkblue">Software Usage Analysis of LAB A</b>
                    ...
                    <div class="row">
                        ...
                        <div class="page-header">
                            ...
                            <h3 class="page-title">
                                ...
                                </span><b style="text-transform: uppercase; font-size: 20px; color: darkblue">Actual Usage of Softwares in LAB A</b>
                    ...
                    <div class="row">
                        ...
                        <div class="page-header">
                            ...
                            <h3 class="page-title">
                                ...
                                </span><b style="text-transform: uppercase; font-size: 20px; color: darkblue">Expected Usage of Softwares in LAB A According to Time Table</b>
    ...
    <script> 
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Observed Days',
                    backgroundColor: "#84dafc",
                    data: chartData1,
                }, {
                    label: 'Observed Weeks',
                    backgroundColor: "#0f29b4",
                    data: chartData2,
                }],
            },
            options: {
