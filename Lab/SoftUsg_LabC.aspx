<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoftUsg_LabC.aspx.cs" Inherits="Lab.SoftUsg_LabC" %>
                ...
                <div class="content-wrapper" style="background-color: #ffe9e9">
                    ...
                    <div class="page-header">
                        ...
                        <h3 class="page-title">
                            ...
                            </span><b style="text-transform:uppercase;font-size:21px;color:darkblue">Software Usage Analysis of LAB C</b> 
                    ...
                    <div class="row">
                        ...
                        <div class="page-header">
                            ...
                            <h3 class="page-title">
                                ...
                                </span><b style="text-transform:uppercase;font-size:20px;color:darkblue">Actual Usage of Softwares in LAB C</b>
