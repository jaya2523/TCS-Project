<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LAB_C.aspx.cs" Inherits="Lab.LAB_C" %>
...
<body onload="startLoop();">
                ...
                <div class="content-wrapper" style="background-color: #ffe9e9">
                    ...
                    <div class="page-header">
                        ...
                        <h3 class="page-title">
                            ...
                            </span><b style="text-transform: uppercase; font-size: 20px; color: darkblue">LAB C Hardware Usage Analysis</b>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 stretch-card grid-margin">
                            <marquee behavior="scroll" direction="up" scrollamount="6" id="myMarquee1">
                                ...
                                <div class="card card-img-holder text-white" style="background-image: linear-gradient(135deg, #ffdb58 10%, #ffcc00 100%);">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h4 class="font-weight-normal mb-3"><b>Actual Resource Consumption
                                            <br />
                                            of LAB C Per Day</b> &nbsp;<i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    ...
                    <div class="col-md-4 stretch-card grid-margin">
                        <marquee behavior="scroll" direction="up" scrollamount="6" id="myMarquee2">
                            ...
                            <div class="card card-img-holder text-white" style="background-image: linear-gradient(135deg, #A71D31 10%,#3F0D12 100%);">
                                ...
                                <div class="card-body">
                                   ...
                                   <h4 class="font-weight-normal mb-3"><b>Actual Resource Consumption
                                            <br />
                                            of LAB C Per Week</b> &nbsp;<i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    ...
                    <div class="col-md-4 stretch-card grid-margin">
                        <marquee behavior="scroll" direction="up" scrollamount="6" id="myMarquee3">
                            ...
                            <div class="card card-img-holder text-white" style="background-image: linear-gradient(135deg,#68b2a0  10%, #2c6975 100%);">
                ...
                <div class="row">
                    ...
                    <div class="page-header">
                        ...
                        <h3 class="page-title">
                            ...
                            </span><b style="text-transform: uppercase; font-size: 20px; color: darkblue">Actual Usage of Systems in LAB C</b>
                ...
                <div class="row">
                    ...
                    <div class="page-header">
                        ...
                        <h3 class="page-title">
                            ...
                            </span><b style="text-transform: uppercase; font-size: 20px; color: darkblue">Expected Usage of Systems in LAB C According to the Time Table</b>
    ...
    <script> 
        ...
        gradient.addColorStop(0, 'rgba(202, 242,112, 100)');
        gradient.addColorStop(0.5, 'rgba(210,255,110,0.5)');
        gradient.addColorStop(1, 'rgba(222,188,255, 0)');
        gradient2.addColorStop(0, 'rgba(0,141,147, 100)');
        gradient2.addColorStop(0.5, 'rgba(0,195,203, 0.5)');
        gradient2.addColorStop(1, 'rgba(189, 255, 188, 0)');
    ...
    <script>
        ...
        gradient.addColorStop(0, 'rgba(49,0,245, 100)');

        gradient.addColorStop(0.5, 'rgba(90,50,255, 0.15)');

        gradient.addColorStop(1, 'rgba(158,134,255, 0)');

        gradient2.addColorStop(0, 'rgba(245,134,0, 100)');

        gradient2.addColorStop(0.5, 'rgba(245,163,0, 0.55)');

        gradient2.addColorStop(1, 'rgba(255, 188,55, 0)');
