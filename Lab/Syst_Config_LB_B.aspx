<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Syst_Config_LB_B.aspx.cs" Inherits="Lab.Syst_Config_LB_B" %>
...
<head runat="server">
 ...
 <style>
    ...
    .darken-grey-text {
        ...
        .hm2-gradient {
           background-image: linear-gradient(135deg, #ff5f6d  10%,  #ffc371 100%);
        }
                ...
                <div class="card-body hm2-gradient">
                    ...
                    <div class="col-md-12">
                            ...
                            <h1 style="color:midnightblue;text-align:center;font-family:'Century';font-weight:bold;">
                               SYSTEM &nbsp;HARDWARE &nbsp;CONFIGURATION <br />LAB &nbsp;B</h1>
                     </div>
                    <br /><br />
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr> <th scope="row">2 </th> <td>System Model </td> <td> Think Centre M710e </td> </tr>

                            <tr> <th scope="row">3 </th> <td>No. of System</td>  <td>04 NOS</td> </tr>

                            <tr> <th scope="row">4 </th> <td>Operating system</td>  <td>Windows 10 Pro 64-bit </td> </tr>

                            <tr> <th scope="row">5 </th> <td>CPU</td> <td>Intel Core i5 7500 @ 3.40GHz (7th Gen)  4 Core,4 Threads</td> </tr>

                            <tr> <th scope="row">6 </th> <td>RAM</td> <td>16.0GB Single-DDR4</td> </tr>

                            <tr> <th scope="row">7 </th> <td>MotherBoard</td> <td>LENOVO 313C (U3E1)</td> </tr>

                            <tr> <th scope="row">8 </th> <td>Graphics </td> <td>Intel Microsoft Basic Display Adapter (Lenovo)</td> </tr>

                            <tr> <th scope="row">9 </th> <td>Storage</td> <td>1TB Western Digital WDC, Head-16, 7200 RPM</td> </tr>

                            <tr> <th scope="row">10 </th> <td>Monitor</td> <td>Lenovo Thinkvision 21.5"</td></tr>

                            <tr> <th scope="row">11 </th> <td>Keyboard</td> <td>Lenovo USB KBBH21</td> </tr>

                            <tr> <th scope="row">12 </th> <td>Mouse</td> <td>Lenovo USB Optical SM- 8823/MOJUUO</td> </tr>
