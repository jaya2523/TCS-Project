<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Syst_Config_LB_D.aspx.cs" Inherits="Lab.Syst_Config_LB_D" %>
                   ...
                   <br />
                    ...
                    <div class="col-md-12">
                            ...
                            <h1 style="color:white;text-align:center;font-family:'Century';font-weight:bold;">
                                SYSTEM &nbsp;HARDWARE &nbsp;CONFIGURATION <br />LAB &nbsp;D</h1>
                     </div>
                    <br /><br />
                    ...
                    <table class="table table-hover" style="color:white">
                        ...
                        <tbody>
                            ...
                            <tr> <th scope="row">1 </th> <td>System Make </td>   <td>Dell</td>   </tr>

                            <tr> <th scope="row">2 </th> <td>System Model </td> <td>Optiplex 3050</td> </tr>

                            <tr> <th scope="row">3 </th> <td>No. of System</td>  <td>50 NOS</td> </tr>

                            <tr> <th scope="row">4 </th> <td>Operating system</td>  <td>Windows 10 Pro 64-bit </td> </tr>

                            <tr> <th scope="row">5 </th> <td>CPU</td> <td>Intel Core i3-7100 CPU @ 3.90GHz (7th gen)  2 Core,4 Threads</td> </tr>

                            <tr> <th scope="row">6 </th> <td>RAM</td> <td>4.0GB Single-DDR4</td> </tr>

                            <tr> <th scope="row">7 </th> <td>MotherBoard</td> <td>Dell Inc. (U3E1)</td> </tr>

                            <tr> <th scope="row">8 </th> <td>Graphics </td> <td>Intel Microsoft Basic Display Adapter (Dell)</td> </tr>

                            <tr> <th scope="row">9 </th> <td>Storage</td> <td>1TB Western Digital WDC, Head-16, 7200 RPM</td> </tr>

                            <tr> <th scope="row">10 </th> <td>Monitor</td> <td>DELL P2217H 22"</td></tr>

                            <tr> <th scope="row">11 </th> <td>Keyboard</td> <td>Dell USB  (KB216t)</td> </tr>

                            <tr> <th scope="row">12 </th> <td>Mouse</td> <td>Dell USB Optical MS116p</td> </tr>
